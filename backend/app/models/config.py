...
class Config(Base):
    ...
    settings: Mapped[List["Setting"]] = relationship(back_populates="config", cascade="all, delete-orphan")  # noqa: F821
    sdk_keys: Mapped[List["SDKKey"]] = relationship(back_populates="config", cascade="all, delete-orphan")  # noqa: F821
